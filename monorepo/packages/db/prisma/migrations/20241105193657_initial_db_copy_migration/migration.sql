...
CREATE TABLE "BoilerCode" (
    ...
    CONSTRAINT "BoilerCode_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "FullCode" (
    "id" TEXT NOT NULL,
    "languageId" INTEGER NOT NULL,
    "problemId" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    ...
    CONSTRAINT "FullCode_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BoilerCode_problemId_languageId_key" ON "BoilerCode"("problemId", "languageId");

-- CreateIndex
CREATE UNIQUE INDEX "FullCode_problemId_languageId_key" ON "FullCode"("problemId", "languageId");
...
-- AddForeignKey
ALTER TABLE "BoilerCode" ADD CONSTRAINT "BoilerCode_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES "Problem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BoilerCode" ADD CONSTRAINT "BoilerCode_languageId_fkey" FOREIGN KEY ("languageId") REFERENCES "Language"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FullCode" ADD CONSTRAINT "FullCode_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES "Problem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FullCode" ADD CONSTRAINT "FullCode_languageId_fkey" FOREIGN KEY ("languageId") REFERENCES "Language"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
